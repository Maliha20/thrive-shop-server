...
router.post('/create-product', validateRequests(productValidationSchema) ,productControllers.createProduct) 
router.get('/',productControllers.getAllProducts) 
router.get('/:id' ,productControllers.getAProduct) 
router.put('/:id',validateRequests(updateProductValidationSchema), productControllers.updateAProduct)
